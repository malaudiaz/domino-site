...
export default function TeamsPage() {
  ...
  const fetchData = async () => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}teams/${profile.id}?page=${page}&per_page=${rowsPerPage}`;
  ...
  const delItem = async (id) => {
    const url = `${process.env.NEXT_PUBLIC_API_URL}teams/${id}`;
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      text: "¿ Deseas eliminar éste Equipo ?",
      icon: "question",
