  ...
  const posts = [
    {
        ...
        photos: [{path: "/dance.jpg"}, {path: "/marc-kleen-H02BVUa2IVY-unsplash.jpg"}],
        amountLike: 35
    },
    {
      id: 2,
      ...
      elapsed: "3 d",
      comment: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Lorem ipsum dolor sit amet",
      amountComment: 0,
      comments: [],
      photos: [{path: "/marc-kleen-H02BVUa2IVY-unsplash.jpg"}, {path: "/dance.jpg"}],
      amountLike: 1500
    }
  ];
