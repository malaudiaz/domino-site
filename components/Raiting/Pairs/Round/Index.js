...
export default function PairsPositions({ id, active }) {
    ...
    const fetchData = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}rounds/scale/player/pairs/${id}?page=${page}&per_page=${rowsPerPage}`;
                ...
                <div className="wrapper">
                    <div style={{ textAlign: "center" }}>
                        ...
                        <div className="pt-4 fs-5">
                            La clasificación por parejas de la ronda, aparecerá aquí
                        </div>
                    </div>
                </div>
            )}
