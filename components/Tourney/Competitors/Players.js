...
export default function Players({tourney}) {
    ...
    const fetchData = async () => {
        const url = `${process.env.NEXT_PUBLIC_API_URL}player?tourney_id=${tourney.id}&page=${page}&per_page=${rowsPerPage}`;
                ...
                <>
                    <div className="d-flex flex-wrap gap-2 justify-content-between align-items-center pt-2 px-4 pb-1">
                        ...
                        <Button
                            ...
                            disabled={
                                tourney.status_name !== "CREATED" || players.length === 0
                            }
                            onClick={(e) => {
                                handleApprobe(e);
                            }}
