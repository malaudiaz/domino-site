...
export default function Lottery({ tourney, setMenu }) {
                ...
                >
                  ...
                  >
                    <span className="badge text-bg-success">
                      {tourney.lottery_type==="MANUAL" ? getNumberAsign(item.id) : <small>B{getNumberAsign(item.id)}</small>}
                    </span>
                  </h6>
                </div>
